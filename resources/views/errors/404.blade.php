...
@section('content')
	...
	<div id="index-banner" class="parallax-container">
		<div class="section no-pad-bot">
			<div class="container">
				<br><br>
				<h1 class="header center orange-text text-darken-3">Foutmelding - 404</h1>
				<div class="row center">
					<h5 class="header col s11 text-darken-4">Er is iets mis gegaan! We konden deze pagina niet vinden.</h5>
				</div>
				<div class="row center">
